  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <Table striped bordered hover size="sm" style={{marginTop: "20px", width: "800px"}}>
          ...
          <tbody>
            <tr>
              ...
              <td>contains list of faculty and admin information</td>
              <td>2020.5.30</td>
            </tr>
        ...
        <h5>Upload Excel File to Update Backend Information</h5>
        <Form>
          <Form.Group>
            <Form.Label>The file format should be EXACTLY the same as the file above!</Form.Label>
            <br />
